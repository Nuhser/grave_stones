...
scoreboard players operation @e[type=area_effect_cloud,tag=gs_graveMarker,distance=..1,limit=1,sort=nearest,nbt={Age:0}] gs_id = @s nuhser_id
...
execute positioned ~ -3 ~ run scoreboard players operation @e[type=area_effect_cloud,tag=gs_graveMarker,distance=..1,limit=1,sort=nearest,nbt={Age:0}] gs_id = @s nuhser_id
...
execute as @e[tag=gs_graveMarker,tag=gs_deathPoint,nbt={Age:0}] at @s run function grave_stones:build_grave_stone

#write coordinates in chat
execute as @e[tag=gs_graveMarker,tag=gs_deathPoint,nbt={Age:0}] at @s if score $tell_coordinates gs_deaths matches 1 run function grave_stones:print_coordinates
